...
<qgis version="3.24.3-Tisler">
  <identifier>KAMBT_COMBINE</identifier>
  <parentidentifier></parentidentifier>
  <language>IND</language>
  <type>dataset</type>
  <title>KAMBT_COMBINE</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" name="Shapefile" type="Local Area Network" format="" mimeType="" url="file://" description=""/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial crs="EPSG:32647" maxz="0" maxx="0" dimensions="2" minz="0" maxy="0" miny="0" minx="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
