...
<qgis version="3.24.3-Tisler">
  <identifier>KSKAR_COMBINE</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>KSKAR_COMBINE</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" size="" description="" type="Local Area Network" name="Shapefile" mimeType="" url="file://\\HP-5D832A45439D\E$\pn3_2011\@FIX\ksbar\tan_ksbar_edit_kroscek_Disso.shp"/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial crs="EPSG:32647" maxz="0" maxy="0" minx="0" minz="0" dimensions="2" miny="0" maxx="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
