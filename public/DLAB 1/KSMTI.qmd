...
<qgis version="3.24.3-Tisler">
  <identifier>KSMTI_COMBINE</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>KSMTI_COMBINE</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" size="" description="" type="Local Area Network" name="Shapefile" mimeType="" url="file://\\XPWINDOWS7\D$\PN3_2012\Kebun Sei Meranti\TANAMAN_sei_meranti_FIX"/>
  </links>
  <fees></fees>
