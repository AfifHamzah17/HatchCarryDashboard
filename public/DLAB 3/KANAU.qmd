...
<qgis version="3.24.3-Tisler">
  <identifier>AFD_I_KANAU_Merge</identifier>
  <parentidentifier></parentidentifier>
  <language>IND</language>
  <type>dataset</type>
  <title>AFD_I_KANAU_Merge</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" size="" description="" type="Local Area Network" name="Shapefile" mimeType="" url="file://\\HP-5D832A45439D\E$\pn3_2011\@FIX\kanau\blok_kanau_PAS.shp"/>
  </links>
  <fees></fees>
