    ...
    <div className="full-page-container">
      <style>
        {`
          .full-page-container {
            ...
            align-items: center;
            background: linear-gradient(to bottom, #87CEEB 0%, #E0F7FA 60%, #B3DCDF 100%);
          }
      ...
      <div className="svg-container">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 355">
          ...
          {/* Palm Tree */}
          <g id="palm-tree" transform="translate(900, 250)">
            {/* Trunk */}
            <path d="M0,0 L0,-40 L5,-40 L5,0 Z" fill="#8B4513" />
            {/* Leaves */}
            <g transform="translate(2.5, -40)">
              <path d="M0,0 Q-20,-10 -30,-30" stroke="#228B22" strokeWidth="3" fill="none" />
              <path d="M0,0 Q20,-10 30,-30" stroke="#228B22" strokeWidth="3" fill="none" />
              <path d="M0,0 Q-10,-20 -15,-40" stroke="#228B22" strokeWidth="3" fill="none" />
              <path d="M0,0 Q10,-20 15,-40" stroke="#228B22" strokeWidth="3" fill="none" />
              <path d="M0,0 Q0,-25 0,-45" stroke="#228B22" strokeWidth="3" fill="none" />
            </g>
            {/* Coconuts */}
            <circle cx="0" cy="-35" r="4" fill="#8B4513" />
            <circle cx="-8" cy="-32" r="4" fill="#8B4513" />
            <circle cx="8" cy="-32" r="4" fill="#8B4513" />
          </g>
